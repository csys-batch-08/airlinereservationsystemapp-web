...
.container {
	...
	<main class="container-fluid">
		...
		<script>
				...
				$
						.ajax({
							...
							success : function(response) {
								if (response
										.includes("Email id Already Registered")) {
			...
			function validuser() {
				...
				$
						.ajax({
							...
							success : function(response) {
								if (response
										.includes("User Name already Registered")) {
			...
			function phonenumber() {
				...
				$
						.ajax({
							...
							success : function(response) {
								if (response
										.includes("Mobile Number Already Present")) {
			...
			document.getElementById("Male").onkeydown = function() {
				myfunction()
			};
