	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="active"
					style="position: relative; left: 30px; font-size: 18px"><a
					href="Sourcedestination">Home</a></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<c:if test="${loggedInAsAdmin == null && loggedInAsUser == null}">
					<li class="nav-item"><a href="login.jsp"><span
							class="glyphicon glyphicon-user"></span> Login</a></li>
					<li class="nav-item"><a href="register.jsp"><span
							class="glyphicon glyphicon-log-in"></span> Register</a></li>
					<li class="nav-item"><a href="guestlogin.jsp"><span
							class="glyphicon glyphicon-log-in"></span> Guest Login</a></li>
				</c:if>
				<c:if test="${loggedInAsUser == null && loggedInAsAdmin != null}">
					<li class="nav-item"><a class="nav-link" href="#">Welcome
							${loggedInAsAdmin}</a></li>
					<li class="nav-item"><a class="nav-link"
						class="btn btn-warning" href="LogoutServlet">Logout</a></li>
				</c:if>
				<c:choose>
						...
						<c:choose>
							<c:when test="${loggedInAsUser== 'Guest'}">
								...
								<li class="nav-item"><a class="nav-link" href=#>My
										Wallet</a></li>
								<li class="nav-item"><a class="nav-link" href=Guestcancel>Cancel
										Booking</a></li>
							</c:when>
							<c:otherwise>
								<li class="nav-item"><a class="nav-link"
									href="mywallet.jsp">My Wallet</a></li>
								<li class="nav-item"><a class="nav-link"
									href="CancelTicket">Cancel Booking</a></li>
							</c:otherwise>
						</c:choose>
					</c:when>
				</c:choose>
